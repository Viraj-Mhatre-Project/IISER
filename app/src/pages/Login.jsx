    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md glass-card p-10 rounded-3xl animate-in fade-in zoom-in duration-500">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-white tracking-tight">Access Node</h2>
          <p className="text-sm text-zinc-500 mt-2 font-medium tracking-wide">Authenticate to enter SpeedSense AI</p>
        </div>
